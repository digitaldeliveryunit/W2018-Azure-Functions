...
{
    public class SeedingDataV2
    {
        private readonly CosmosDBOptions _options;
        private readonly DocumentClient _client;

        public SeedingDataV2(IOptions<CosmosDBOptions> optionsAccessor)
        {
        ...
        public void Seeding()
        {
            ...
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_USER }).Wait();
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_LOCATION }).Wait();
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_VENUE }).Wait();
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_EVENT }).Wait();
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_SESSION }).Wait();
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_SUBSESSION }).Wait();
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_BOOKMARK }).Wait();
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_EVENT_MEMBER }).Wait();
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_SPOTLIGHT }).Wait();
            _client.CreateDocumentCollectionIfNotExistsAsync(UriFactory.CreateDatabaseUri(_options.DatabaseId), new DocumentCollection() { Id = CollectionNameConstant.COLLECTION_MEDIA }).Wait();
