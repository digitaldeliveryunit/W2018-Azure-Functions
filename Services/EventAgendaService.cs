...
namespace com.petronas.myevents.api.Services
{
    public class EventAgendaService : IEventAgendaService
    {
        ...
        private readonly ISubSessionRepository _subSessionRepossitory;
        private readonly IUserService _userService;
        public EventAgendaService(ISessionRepository sessionRepossitory, ISubSessionRepository subSessionRepossitory, IUserService userService)
        {
            _sessionRepossitory = sessionRepossitory;
            _subSessionRepossitory = subSessionRepossitory;
