...
namespace com.petronas.myevents.api.Constants
{
    public class CollectionNameConstant
    {
        ...
        public const string COLLECTION_LOCATION = "Locations";
        public const string COLLECTION_BOOKMARK = "Bookmarks";
        public const string COLLECTION_EVENT = "Events";
        public const string COLLECTION_EVENT_MEMBER = "EventMembers";
        public const string COLLECTION_MEDIA = "Medias";
        public const string COLLECTION_SESSION = "Sessions";
        public const string COLLECTION_SPOTLIGHT = "Spotlights";
