        ...
        public void InitDbAndDataSeending()
        {
            ...
            var Events = new List<Event>(){
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 1",
                    EventType = "Public",
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 2",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 3",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 4",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 5",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 6",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 7",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 8",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 9",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 10",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 11",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 12",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 13",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 14",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 15",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
                ...
                new Event(){
                    ...
                    Spotlights = new List<Spotlight>(),
                    Id = Guid.NewGuid().ToString(),
                    EventName = "PETRONAS ICT Core Academy Foundation for Executives 16",
                    EventType = "Public",
                    EventDateTo = new DateTime(2018,12,28,16,0,0),
                    EventStatus = "Published",
                    EventDateFrom = new DateTime(2018,12,23,8,30,0),
